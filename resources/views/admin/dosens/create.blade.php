                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <input type="text" name="affiliation" id="affiliation"
                                           ...
                                           value="{{ old('affiliation') }}" placeholder="Contoh: Universitas Negeri X">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="email" name="email" id="email"
                                           ...
                                           value="{{ old('email') }}" placeholder="email@domain.ac.id">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="department" id="department"
                                           ...
                                           value="{{ old('department') }}" placeholder="Contoh: Teknik Informatika">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="academic_grade" id="academic_grade"
                                           ...
                                           value="{{ old('academic_grade') }}" placeholder="Contoh: Lektor Kepala">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="level_department" id="level_department" class="form-select @error('level_department') is-invalid @enderror">
                                        ...
                                        <option value="s1" {{ old('level_department') == 's1' ? 'selected' : '' }}>S1</option>
                                        <option value="s2" {{ old('level_department') == 's2' ? 'selected' : '' }}>S2</option>
                                        <option value="s3" {{ old('level_department') == 's3' ? 'selected' : '' }}>S3</option>
                                    </select>
