        ...
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark font-weight-bold">
                    <i class="fas fa-edit mr-2 text-warning"></i>Edit Jurnal
                </h1>
            </div>
            <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            ...
                            <select name="jenis_jurnal" id="jenis_jurnal" class="form-control @error('jenis_jurnal') is-invalid @enderror">
                                ...
                                @foreach(\App\Models\Jurnal::getJenisJurnalOptions() as $key => $label)
                                    <option value="{{ $key }}" {{ old('jenis_jurnal', $jurnal->jenis_jurnal) == $key ? 'selected' : '' }}>
                                        {{ $label }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select name="status" id="status" class="form-control @error('status') is-invalid @enderror">
                                ...
                                @foreach(\App\Models\Jurnal::getStatusOptions() as $key => $label)
                                    <option value="{{ $key }}" {{ old('status', $jurnal->status) == $key ? 'selected' : '' }}>
                                        {{ $label }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select name="akreditasi" id="akreditasi" class="form-control @error('akreditasi') is-invalid @enderror">
                                ...
                                @foreach(\App\Models\Jurnal::getAkreditasiOptions() as $key => $label)
                                    <option value="{{ $key }}" {{ old('akreditasi', $jurnal->akreditasi) == $key ? 'selected' : '' }}>
                                        {{ $label }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select name="tahun" id="tahun" class="form-control @error('tahun') is-invalid @enderror">
                                ...
                                @for($year = date('Y'); $year >= 2000; $year--)
                                    <option value="{{ $year }}" {{ old('tahun', $jurnal->tahun) == $year ? 'selected' : '' }}>
                                        {{ $year }}
                                    </option>
                                @endfor
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            @if($jurnal->file_pdf)
                                <div class="mb-2">
                                    <small class="text-success">
                                        ...
                                        File saat ini: {{ basename($jurnal->file_pdf) }}
                                        <a href="{{ Storage::url($jurnal->file_pdf) }}" target="_blank" class="ml-2 text-primary">
                            ...
                            <div class="custom-file">
                                ...
                                <label class="custom-file-label" for="file_pdf">
                                    {{ $jurnal->file_pdf ? 'Pilih file PDF baru...' : 'Pilih file PDF...' }}
                                </label>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            @if($jurnal->cover_image)
                                <div class="mb-2">
                                    <small class="text-success">
                                        ...
                                        Gambar saat ini: {{ basename($jurnal->cover_image) }}
                                        <a href="{{ Storage::url($jurnal->cover_image) }}" target="_blank" class="ml-2 text-primary">
                                            <i class="fas fa-external-link-alt"></i> Lihat
                                        </a>
                                    </small>
                                </div>
                            ...
                            <div class="custom-file">
                                ...
                                <label class="custom-file-label" for="cover_image">
                                    {{ $jurnal->cover_image ? 'Pilih gambar baru...' : 'Pilih gambar...' }}
                                </label>
                            </div>
